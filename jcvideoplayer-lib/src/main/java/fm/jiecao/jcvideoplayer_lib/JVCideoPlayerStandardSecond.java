...
public class JVCideoPlayerStandardSecond extends JCVideoPlayer {
    ...
    private void downloadUrl(String mVideoPath) {
        ...
        Toast.makeText(mContext, (R.string.f1), Toast.LENGTH_SHORT).show();
        if (mVideoPath.startsWith("http")) {
            ...
            if (!f.exists()) {
                ...
                Toast.makeText(mContext, (R.string.f2), Toast.LENGTH_SHORT).show();
            } else
                Toast.makeText(mContext, (R.string.f3), Toast.LENGTH_SHORT).show();
        }
