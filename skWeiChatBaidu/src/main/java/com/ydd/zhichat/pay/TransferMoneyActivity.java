...
public class TransferMoneyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isGroup = getIntent().getBooleanExtra(AppConstant.EXTRA_IS_GROUP_CHAT,false);
        roomJid = getIntent().getStringExtra(AppConstant.EXTRA_ROOM_JID);
        initActionBar();
        initView();
        initEvent();
        initKeyBoad();
                ...
                .execute(new BaseCallback<Transfer>(Transfer.class) {
                    ...
                    public void onResponse(ObjectResult<Transfer> result) {
                        ...
                        if (result.getResultCode() != 1) {
                            ...
                            if(isGroup) {
                                message.setFilePath(words+"|"+mTransferredName+"|"+mTransferredUserId+"|"+coreManager.getSelf().getUserId()); // 转账说明
                            }else{
