...
public class TransferMoneyDetailActivity extends BaseActivity {
    ...
    public static final int EVENT_SURE_OK = 10003; // 确认领取(目标已收款)
    ...
    private void initEvent() {
        mTransferTips3Tv.setOnClickListener(v -> {
            if (mTransfer.getStatus() == 1) {
                ...
                chatMessage.setType(XmppMessage.TYPE_TRANSFER_RECEIVE);
                chatMessage.setContent(chatMessage.getContent()+"|"+EVENT_REISSUE_TRANSFER);
