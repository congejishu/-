...
class HeadViewHolder extends BaseRecViewHolder {
    ...
    public void onBind(List<TransferRecord.DataBean.PageDataBean> list, int position) {
        ...
        if ((month - 1) == Calendar.getInstance().get(Calendar.MONTH)) {
            tv_month.setText(R.string.a16);
        } else {
            tv_month.setText("0" + month + MyApplication.getInstance().getString(R.string.a17));
        }
...
class TransferViewHolder extends BaseRecViewHolder {
    ...
    public void onBind(List<TransferRecord.DataBean.PageDataBean> list, int position) {
        ...
        tv_receipt.setText(list.get(position).getStatus() == 1 ? MyApplication.getInstance().getString(R.string.a18) : MyApplication.getInstance().getString(R.string.a20));//状态
