...
public class User implements Parcelable, Cloneable {
    ...
    private long endVipTime;//vip时间
    private int uidIndex = -1;
    private String cityKey = "";//朋友圈城市
    private Integer circlePower = 0;//是否购买朋友圈权限

    public Integer getCirclePower() {
        return circlePower;
    }
    ...
    public void setCirclePower(Integer circlePower) {
        this.circlePower = circlePower;
    }
    ...
    public void setUidIndex(int uidIndex) {
        this.uidIndex = uidIndex;
    }

    public void setEndVipTime(long data){
        this.endVipTime = data;
    }
