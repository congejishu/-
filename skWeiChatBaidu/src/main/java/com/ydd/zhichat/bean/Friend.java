...
public class Friend implements Serializable {
    ...
    @DatabaseField(columnName = "restoreIndex",defaultValue = "0")
    private Integer restoreIndex;
    @DatabaseField(columnName = "restoreStatue",defaultValue = "0")
    private Integer restoreStatue;
    @DatabaseField(columnName = "restoreStatue01",defaultValue = "0")
    private Integer restoreStatue01;
    //@DatabaseField(columnName = "restoreList")
    @DatabaseField(dataType = DataType.SERIALIZABLE)
    private ArrayList<AutoReplyMessage.Restores> restoreList = new ArrayList<>();
    @DatabaseField(defaultValue = "0")
    private Integer vip;
    @DatabaseField(defaultValue = "0")
    ...
    public void setRestoreList(ArrayList<AutoReplyMessage.Restores> restoreList) {
    ...
    public ArrayList<AutoReplyMessage.Restores> getRestoreList() {
        return restoreList;
    }
