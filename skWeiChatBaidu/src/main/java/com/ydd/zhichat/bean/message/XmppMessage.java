...
public abstract class XmppMessage {
    ...
    public static final int CIRCLETIP = 305;// 朋友圈关键字提示
    ...
    public static final int TYPE_R_Record = 950;
    public static final int TYPE_R_AUTO_REPLY=951;//自动回复
    public static final int TYPE_VIP_CONFIG = 952;//会员配置更新
    public static final int TYPE_VIP_STUATE_SUCCESS = 953;// vip购买成功
    public static final int TYPE_VIP_STUATE_FAILURE = 954;// vip购买失败
    public static final int TYPE_VIP_STUATE_EXPIRE = 955;// vip到期


    public static final int TYPE_Edit_TEXT = 960;//编辑文本
