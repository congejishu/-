...
public class Constants {
    ...
    //item_chat_transfer
    public final static String SHOW_TRANSFER_MENU = AppConfig.sPackageName + "show_transfer_menu";
    // 单、群聊 清空聊天记录
    ...
    public final static String MESSAGE_READ_FIRE_1 = "message_read_fire_ex1_";
    public final static String MESSAGE_READ_FIRE_2 = "message_read_fire_ex2_";
    public final static String MESSAGE_READ_FIRE_3 = "message_read_fire_ex3_";
