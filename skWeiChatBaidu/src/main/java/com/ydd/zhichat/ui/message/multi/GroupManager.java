...
public class GroupManager extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomMode = getIntent().getIntExtra("roomMode",0);
        initAction();
        initView();
    }
    ...
    private void initView() {
        ...
        if(roomMode == 1) {
            findViewById(R.id.set_password_rl).setVisibility(View.VISIBLE);
            findViewById(R.id.set_password_rl).setOnClickListener((view)->{
                ...
                myAlertInputDialog.setPositiveButton("确认", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        password = myAlertInputDialog.getResult();
                        updateGroupHostAuthorityPwd();
                        EventGroupStatus eventGroupStatus = new EventGroupStatus(-1,-1);
                        eventGroupStatus.setPasswrod(password);
        ...
        findViewById(R.id.copy_rl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roomRole == 1 || roomRole == 2) {
                    ...
                    startActivity(intent);
                    finish();
                } else tip(getString(R.string.b75));
            }
        });
    }

    private void updateGroupHostAuthorityPwd() {
