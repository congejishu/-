...
import static com.ydd.zhichat.AppConstant.EXTRA_IMAGE_URI;
...
public class SingleImagePreviewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            mImageUri = getIntent().getStringExtra(EXTRA_IMAGE_URI);
    ...
    public static void start(Context cxt, String url) {
        start(cxt, url, "");
    }
    public static void start(Context cxt, String url, String filePath) {
        start(cxt, url, filePath, false, false, "", "", false, false, 0, "");
    }

    public static void startAvatar(Context cxt, String url) {
        start(cxt, url, "", true, false, "", "", false, false, 0, "");
    }

    public static void startMsgReadDestroy(Context cxt, String url, String filePath, String messageId) {
        start(cxt, url, filePath, false, true, messageId, "", false, false, 0, "");
    }

    public static void startD2C(Context cxt, String url, String json, boolean isCollection) {
        start(cxt, url, "", false, false, "", json, isCollection, false, 0, "");
    }

    public static void startCloud(Context cxt, String url, int isTeam, String affiliateId) {
        start(cxt, url, "", false, false, "", "", false, true, isTeam, affiliateId);
    }
    ...
    public static void start(Context cxt
            ...
            , String filePath
            , boolean isAvatar
            , boolean isMsgReadDestroy, String messageId
            , String json, boolean isCollection
            , boolean isCloud, int isTeam, String affiliateId) {
        Intent intent = new Intent(cxt, SingleImagePreviewActivity.class);
        intent.putExtra(EXTRA_IMAGE_URI, url);
