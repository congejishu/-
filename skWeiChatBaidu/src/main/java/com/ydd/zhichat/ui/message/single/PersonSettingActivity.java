    ...
    private void initView() {
        ...
        if(MyApplication.mCoreManager.getConfig().vipConfig.getAutoReply() == 1) {
            if(MyApplication.mCoreManager.getSelf().getVip() < 1) {
                ...
                findViewById(R.id.sync_chat_history_empty).setVisibility(View.VISIBLE);
            }
        }else{
            findViewById(R.id.sync_chat_history_empty).setVisibility(View.VISIBLE);
        }
        ...
        if(mFriend.getVip() > 0) {
            mFriendNameTv.setTextColor(MyApplication.getInstance().getResources().getColor(R.color.color_red));
        }else{
            mFriendNameTv.setTextColor(MyApplication.getInstance().getResources().getColor(R.color.color_black));
        }
