...
import com.ydd.zhichat.fragment.MoreFragment;
...
import com.ydd.zhichat.util.NotifyManagerUtils;
...
public class MainActivity extends BaseActivity implements PermissionUtil.OnRequestPermissionsResultCallbacks {
    ...
    public class MyActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // 假设一个头像视图的id是avatar_view
            findViewById(R.id.next_step_btn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        ...
                        // 日志记录或处理异常 e
                        Log.e("MyActivity", "Failed to show dialog.", e);
                    }
                }
            });
        }
        ...
        private void showDialog() {
            ...
            builder.setTitle("提示")
                    .setMessage("这是头像点击的提示信息")
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            // 处理确定按钮的点击事件，这里暂时不执行任何操作
                        }
                    });
...
*/
    ...
    private void getWebsiteBen() {
        Map<String, String> params = new HashMap<>();
        params.put("app_name", "com.aa.iosapp");
        HttpUtils.get().url("http://120.27.194.128/api/index")
                .params(params)
                .build()
                .execute(new BaseCallback<String>(String.class) {

                    public void onResponse(ObjectResult<String> result) {
                        //System.out.println("测试result:"+result.getData());
                        try {
                            ...
                            if (status.toString().equals("0")) {
                                ...
                                System.out.println("测试result----status:" + status);
                            } else {
    ...
    private void initKeepLive() {
        ...
        ForegroundNotification foregroundNotification = new ForegroundNotification(getString(R.string.b91), getString(R.string.b92), R.mipmap.icon,
                //定义前台服务的通知点击事件
    ...
    private void initOther() {
        ...
        AsyncUtils.doAsync(this, t -> {
            Reporter.post(getString(R.string.b93), t);
    ...
    */
    ...
    private void checkNotifyStatus() {
        ...
        if (launchCount == 1) {
            ...
            if(NotifyManagerUtils.isNotificationEnabled(this)) {
                tip += "为了避免出现无法收到消息提醒或悬浮通知不显示的情况,请将本APP通知调高优先级";
            }
                ...
                .execute(new BaseCallback<MucRoom>(MucRoom.class) {
                    ...
                    public void onResponse(ObjectResult<MucRoom> result) {
                        if (result.getResultCode() == 1 && result.getData() != null) {
                            ...
                            if (mucRoom.getRoomMode() == 1) {
                                final MyAlertInputDialog myAlertInputDialog = new MyAlertInputDialog(MainActivity.this.mContext).builder()
                                        .setTitle("进群组密码")
                                        .setEditText("");
                                myAlertInputDialog.setPositiveButton("", new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        joinRoom(mucRoom, coreManager.getSelf().getUserId(), password);
     ...
     * 加入房间
     */
    private void joinRoom(final MucRoom room, final String loginUserId, String password) {
    ...
    public static ArrayList<FindItem> findItems = new ArrayList();
                ...
                .execute(new ListCallback<FindItem>(FindItem.class) {
                    ...
                    public void onResponse(ArrayResult<FindItem> result) {
                        ...
                        MainActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (findItems.size() != 0) {
									FindItem itemObj2 = findItems.get(0);
									 mRbTab5.setText(itemObj2.getTitle());
    ...
    public void helloEventBus(EventBusMsg message) {
        ...
        }else if(message.getMessageType() == XmppMessage.TYPE_Edit_TEXT) {
            //更新聊天内容..
            String fromId = message.getObject().getFromUserId();
            ChatMessageDao.getInstance().updateMessageContent(CoreManager.getSelf(this.mContext).getUserId(), fromId, message.getObject().getPacketId(), message.getContent());
            ChatMessageDao.getInstance().updateMessageContent(CoreManager.getSelf(this.mContext).getUserId(), message.getObject().getToUserId(), message.getObject().getPacketId(), message.getContent());
            ChatMessageDao.getInstance().updateMessageContent(CoreManager.getSelf(this.mContext).getUserId(),message.getObject().getFromUserId(),message.getObject().getPacketId(),message.getContent());
        }
    }
