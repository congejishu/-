...
import com.ydd.zhichat.ui.message.multi.EventGroupStatus;
...
*/
                            ...
                            if(mucRoom.getRoomMode() == 1) {
                                ...
                                myAlertInputDialog.setPositiveButton("", new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        joinRoom(context, mucRoom, mLoginUserId,password);
     ...
     * 加入房间
     */
    private static void joinRoom(Context context, final MucRoom room, final String loginUserId,String password) {
