...
public class CoreManager {
    ...
    public static void appBackstage(Context context, boolean isBack) {
        ...
        if (isBack) {
            str = MyApplication.getInstance().getString(R.string.a60);
...
*/
    ...
    private boolean requireXmppOrReport() {
        ...
        if (!ret) {
            Reporter.post(MyApplication.getInstance().getString(R.string.v4));
        }
        return ret;
    }
    ...
    public void autoReconnect(Activity activity) {
        ...
        if (user != null) {
            ...
            Toast.makeText(activity, (R.string.v5), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void autoReconnectShowProgress(Activity activity) {
        ...
        if (user != null) {
            ...
            Log.e("zq", "自动重连--->本地用户数据空了");
            Toast.makeText(activity, (R.string.v6), Toast.LENGTH_SHORT).show();
        }
    }
}
