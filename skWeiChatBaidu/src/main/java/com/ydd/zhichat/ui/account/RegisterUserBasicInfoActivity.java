...
public class RegisterUserBasicInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(
        ...
        intent.putExtra("thirdTokenyij", thirdTokenyij);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            thirdTokenyij = getIntent().getStringExtra("thirdTokenyij");
...
//        mAvatarImg.setLayoutParams(linearParams);
        ...
        if(coreManager.getConfig().selectAvatarMode == 0) {
            mAvatarImg.setVisibility(View.GONE);
        }


        thirdTokenyij = getIntent().getStringExtra("thirdTokenyij");
        if (thirdTokenyij.length() > 3) {
            // mPhoneNum = getIntent().getStringExtra(RegisterActivity.EXTRA_PHONE_NUMBER);
            nickNameTv.setText(R.string.b94);
            registerYI();
...
//            timer.schedule(task, 100);//3秒后执行TimeTask的run方法
    ...
    public void registerYI() {
        ...
        mTempData.setNickName(getString(R.string.b96));
        mSexTv.setText(R.string.sex_man);

        mCityTv.setText(R.string.b97);
        mTempData.setCityId(310000);
...
//        CameraUtil.pickImageSimple(this, REQUEST_CODE_PICK_CROP_PHOTO);
        ...
        mNewPhotoUri = Uri.fromFile(new File(filePath + fileName));
        Intent captureIntent = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
        captureIntent.putExtra(MediaStore.EXTRA_OUTPUT, mNewPhotoUri);
        ...
        if (requestCode == 99) {
            ...
            if (data != null) {
                ...
                if (uriData != null) {
                    ...
                    CameraUtil.cropImage(this, uriData, mNewPhotoUri, REQUEST_CODE_CROP_PHOTO, 1, 1, 300, 300);
                ...
                Log.e("WangJ", "自定义结果：" + mNewPhotoUri.toString());
                // mUploadCallbackAboveL.onReceiveValue(new Uri[]{imageUri});
                CameraUtil.cropImage(this, mNewPhotoUri, mNewPhotoUri, REQUEST_CODE_CROP_PHOTO, 1, 1, 300, 300);
    ...
    private void register() {
        ...
        if (coreManager.getConfig().selectAvatarMode == 1 && !isSelectAvatar) {
                ...
                .execute(new BaseCallback<LoginRegisterResult>(LoginRegisterResult.class) {
                    ...
                    public void onResponse(ObjectResult<LoginRegisterResult> result) {
                        ...
                        if (!com.xuan.xuanhttplibrary.okhttp.result.Result.checkSuccess(getApplicationContext(), result)) {
                            if (result == null) {
                                Reporter.post(getString(R.string.b98));
                            } else {
                                Reporter.post(getString(R.string.b99) + result.toString());
                            }
                            return;
                        }
                        // 注册成功
                        ...
                        if (success) {
                            ...
                            if (thirdTokenyij.equals("youke")) {

                                ToastUtil.showToast(RegisterUserBasicInfoActivity.this, getString(R.string.b100));
                                ToastUtil.showToast(RegisterUserBasicInfoActivity.this, getString(R.string.b101));
