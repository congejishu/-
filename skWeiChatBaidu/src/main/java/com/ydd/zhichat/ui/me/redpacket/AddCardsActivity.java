...
public class AddCardsActivity extends BaseActivity {
    ...
    private void initActionBar() {
        ...
        mTvTitle.setText(R.string.a23);
    }

    private void initBanks() {
        SelectWindowModel selectWindowModel1 = new SelectWindowModel();
        selectWindowModel1.name = getString(R.string.a24);
        ...
        selectWindowModel2.name = getString(R.string.a25);
        ...
        selectWindowModel3.name = getString(R.string.a26);
        ...
        selectWindowModel4.name = getString(R.string.a27);
        ...
        selectWindowModel5.name = getString(R.string.a28);
        ...
        selectWindowModel6.name = getString(R.string.a29);
        ...
        selectWindowModel7.name = getString(R.string.a30);
    ...
    private void bind(){
        ...
        if (userName == null || TextUtils.isEmpty(userName)) {
            ToastUtil.showLongToast(this,getString(R.string.a31));
        } else if (cardNum == null || TextUtils.isEmpty(cardNum) || cardNum.length() < 0) {
            ToastUtil.showLongToast(this,getString(R.string.a32));
        } else if (cardNum.length() > 30) {
            ToastUtil.showLongToast(this,getString(R.string.a33));
        } else if(selectWindowModel == null){
            ToastUtil.showLongToast(this,getString(R.string.a34));
        }else {
            if (openBankAddr == null || TextUtils.isEmpty(openBankAddr)) {
                openBankAddr = getString(R.string.a35);
            }
