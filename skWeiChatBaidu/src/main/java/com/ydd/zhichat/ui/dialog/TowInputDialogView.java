...
public class TowInputDialogView extends BaseDialog {
    ...
    private AutoCompleteTextView mSecondPa;
   ...
   /* private RelativeLayout mRelativeLayout;
    ...
    protected void initView() {
        ...
        mSecondPa = (AutoCompleteTextView) mView.findViewById(R.id.second_password);
...
//        mCommitBtn.setBackgroundColor(SkinUtils.getSkin(mActivity).getAccentColor());
        ...
        if(!CoreManager.requireConfig(this.mView.getContext()).isRoomMode) {
            mSecondPa.setVisibility(View.GONE);
        }else{
            mSecondPa.setVisibility(View.VISIBLE);
        }
    }
...
*/
        ...
        mCommitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnClickListener != null) {
                    mOnClickListener.onClick(mContentEt, mSecondEt, isRead, isLook, isNeedVerify, isShowMember, isAllowSendCard,mSecondPa);
                }
            }
        });
    }
    ...
    public interface onSureClickLinsenter {
        void onClick(EditText e1, EditText e2, int isRead, int isLook, int isNeedVerify, int isShowMember, int isAllowSendCard,EditText pas);
    }
}
