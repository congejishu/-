                ...
                .execute(new BaseCallback<WXUploadResult>(WXUploadResult.class) {
                    ...
                    public void onResponse(ObjectResult<WXUploadResult> result) {
                        ...
                        if (Result.checkSuccess(getApplicationContext(), result)) {
                            String openId = result.getData().getOpenid();
                            if (TextUtils.isEmpty(openId)) {
                                Toast.makeText(WXEntryActivity.this, MyApplication.getInstance().getString(R.string.a55), Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(WXEntryActivity.this, MyApplication.getInstance().getString(R.string.a56), Toast.LENGTH_SHORT).show();
                            EventBus.getDefault().post(new EventUpdateBandAccount("result", "err"));
                            finish();
                        }
                    }
                ...
                .execute(new BaseCallback<WXUploadResult>(WXUploadResult.class) {
                    ...
                    public void onResponse(ObjectResult<WXUploadResult> result) {
                        ...
                        if (result.getResultCode() == 1 && result.getData() != null) {
                            Toast.makeText(WXEntryActivity.this, MyApplication.getInstance().getString(R.string.a67), Toast.LENGTH_SHORT).show();
                            EventBus.getDefault().post(new EventUpdateBandAccount("result", "ok"));
                            finish();
                        } else {
                            Toast.makeText(WXEntryActivity.this, MyApplication.getInstance().getString(R.string.a68), Toast.LENGTH_SHORT).show();
                            EventBus.getDefault().post(new EventUpdateBandAccount("result", "err"));
                            finish();
                        }
                    }
                ...
                .execute(new BaseCallback<WXUploadResult>(WXUploadResult.class) {
                    ...
                    public void onResponse(ObjectResult<WXUploadResult> result) {
                        ...
                        if (result.getResultCode() == 1 && result.getData() != null) {
                            ...
                            Toast.makeText(WXEntryActivity.this, MyApplication.getInstance().getString(R.string.a69), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
