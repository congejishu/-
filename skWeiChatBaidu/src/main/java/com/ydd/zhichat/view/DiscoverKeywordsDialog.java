 ...
 * 设置朋友圈关键字
 */
public class DiscoverKeywordsDialog extends Dialog {
    private TextView
            mTitle,
            mDescribe,
            mCancel,
    ...
    public DiscoverKeywordsDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selection_keywords);
    ...
    private void initEvent() {
        ...
        mConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                if (mOnSelectionFrameClickListener != null) {
                    mOnSelectionFrameClickListener.confirmClick(mEditText.getText().toString());
                }
            }
        });
    }
    ...
    public interface OnSelectionFrameClickListener {
        ...
        void confirmClick(String edxit);
    }
}
