...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            if (i == 0) {
                ...
                holder.size.setText(getTotalImageSize() + MyApplication.getInstance().getString(R.string.b54));
                if (mFolders.size() > 0) {
    ...
    class ViewHolder {
        ...
        void bindData(Folder data) {
            ...
            size.setText(data.images.size() + MyApplication.getInstance().getString(R.string.b55));
            // 显示图片
            Glide.with(mContext)
