package com.ydd.zhichat.view.spinner.views;
...
import com.ydd.zhichat.view.spinner.adapter.SpinnerAdapter;
...
public class MySpinner extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener{
    ...
    private List<SpinnerModel> mData = new ArrayList<>();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            spinner_pop_background_color = a.getColor(R.styleable.MySpinner_spinner_pop_background_color , getResources().getColor(R.color.white));
    ...
    public void onClick(View view) {
        if(mPopup==null){
            if(contentView==null){//默认样式
                contentView = inflater.inflate(R.layout.spinner_layout_1, null);
    ...
    public void setOnSelectionFrameClickListener(OnSelectionFrameClickListener onSelectionFrameClickListener){
        mOnSelectionFrameClickListener = onSelectionFrameClickListener;
    }
        ...
        if(mStyle==TYPE_SINGLE){
            ...
            srue.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //onSure();
                    if(mOnSelectionFrameClickListener != null) {
                        mOnSelectionFrameClickListener.confirmClick(getSelectData());
                    }
                }
            });
        }
    ...
    public void setSelectVual(JSONArray post) {
        clearSelect();
        for (int i = 0; i < post.size(); i++) {
            String position = post.getString(i);
            for (SpinnerModel spinnerModel : mData) {
                if (spinnerModel.getValue().equals(position)) {
                    spinnerModel.setSelectd(true);
                }
            }
        }
        adapter.notifyDataSetChanged();
    ...
    public interface OnSelectionFrameClickListener {
        ...
        void confirmClick(List<SpinnerModel> data);
    }
}