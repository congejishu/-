...
public class WebMoreDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (httpUrl != null) {
            mBrowserProvideTv.setText(MyApplication.getInstance().getString(R.string.a51) + httpUrl.host() + MyApplication.getInstance().getString(R.string.a66));
        } else {
            mBrowserProvideTv.setText("网页由 " + mUrl + MyApplication.getInstance().getString(R.string.a61));
        }
