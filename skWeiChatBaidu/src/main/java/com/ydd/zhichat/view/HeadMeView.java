 ...
 * 群组是另外的组合头像，
 */
public class HeadMeView extends RelativeLayout {
    ...
    public HeadMeView(Context context) {
        super(context);
        init();
    }

    public HeadMeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HeadMeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public HeadMeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        layout = View.inflate(getContext(), R.layout.view_head_me, this);
