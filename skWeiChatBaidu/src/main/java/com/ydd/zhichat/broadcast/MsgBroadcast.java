...
public class MsgBroadcast {
    ...
    public static final String ACTION_CHAT_SCREENSHOT = AppConfig.sPackageName + ".action.chat_screenshot";// 未读数量需要重置，即从数据库重新查
     ...
     * 更新聊天截屏的广播
     */
    public static void broadcastChatScreenShotUpdate(Context context) {
        context.sendBroadcast(new Intent(ACTION_CHAT_SCREENSHOT));
    }
    /**
     * 更新消息Fragment的广播
     */
