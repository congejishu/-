...
public class PictrueFilterPreviewDialog extends Dialog {
 ...
 /*   private SeekBar.OnSeekBarChangeListener onSeekBarChangeListener1 = new SeekBar.OnSeekBarChangeListener() {
    ...
    private void initDatas() {
        ...
        mdatas.add(new FilterInfo(types[0], MyApplication.getInstance().getString(R.string.b57), R.drawable.filter_thumb_original));
        mdatas.add(new FilterInfo(types[1], MyApplication.getInstance().getString(R.string.b58), R.drawable.filter_thumb_healthy));
        mdatas.add(new FilterInfo(types[2], MyApplication.getInstance().getString(R.string.b59), R.drawable.filter_thumb_nostalgia));
        mdatas.add(new FilterInfo(types[3], MyApplication.getInstance().getString(R.string.b60), R.drawable.filter_thumb_cool));
        mdatas.add(new FilterInfo(types[4], MyApplication.getInstance().getString(R.string.b61), R.drawable.filter_thumb_emerald));
        mdatas.add(new FilterInfo(types[5], MyApplication.getInstance().getString(R.string.b62), R.drawable.filter_thumb_evergreen));
        mdatas.add(new FilterInfo(types[6], MyApplication.getInstance().getString(R.string.b63), R.drawable.filter_thumb_original));
    }
